...
\begin{lstlisting}
https://github.com/kranthiakssy/AI20RESCH14002_PhD_IITH/tree/master/EE5609_Matrix_Theory/Assignment-3
\end{lstlisting}
%
...
\subsection*{Problem:}
Matrix Exercises (12(ii)) :\\ Compute the following.\\[6pt]
\myvec{a^2+b^2&b^2+c^2\\a^2+c^2&a^2+b^2}+\myvec{2ab&2bc\\-2ac&-2ab}
\subsection*{Solution:}
