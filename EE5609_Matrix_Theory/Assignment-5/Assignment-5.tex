...
From the Fig. \ref{fig:tri} it is clear that $\angle ADB > 90^o$ and $ \triangle ABD$ forms an obtuse triangle.\\
Hence, as per the properties of triangles
$$AB^2 > AD^2 + BD^2$$
$$\therefore AB > AD \text{ ,for any length of BD.}$$ 
%\begin{figure}
%\centering
